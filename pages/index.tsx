  ...
  return (
    <div className="p-2 bg-clr1">
      ...
      <main className="gap-2 md:flex">
        ...
        <div className="relative flex flex-col gap-2 mt-5 md:grid md:grid-cols-3 md:mt-0">
          ...
          >
            <Image src={serie[2].image} width={1000} height={1000} alt="pic3" />
          </Link>
          ...
          <Link href="collection/7" className="row-start-3 row-end-5">
            <Image src={serie[6].image} width={1000} height={1000} alt="pic7" />
          </Link>
          <Link href="collection/8" className="row-start-3 row-end-5">
            <Image src={serie[7].image} width={1000} height={1000} alt="pic8" />
          </Link>
        </div>
      </main>
    </div>
